...
class MedicationsControllerTest < ActionController::TestCase
  ...
  test "should create medication" do
    assert_difference('Medication.count') do
      post :create, medication: { description: @medication.description, dosage: @medication.dosage, name: @medication.name, sideeffects: @medication.sideeffects }
    end
  ...
  test "should update medication" do
    patch :update, id: @medication, medication: { description: @medication.description, dosage: @medication.dosage, name: @medication.name, sideeffects: @medication.sideeffects }
    assert_redirected_to medication_path(assigns(:medication))
  end
